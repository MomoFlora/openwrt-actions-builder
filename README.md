...
- 🚀 基于 ImmortalWrt 源码，每周六自动编译，持续获取最新更新  
- 💻 支持 X86、Rockchip 平台，内置常用有线 / 无线 / 3G / 4G 网卡驱动，支持 Kmod 扩展  
- 📊 集成中文版 Netdata 实时监控，小白也能轻松查看系统状态  
- 🏪 ~~ 内置 iStore 应用商店，支持按需安装各类插件 ~~
- 🐳 X86、Rockchip 平台集成 Docker 服务，可在 OpenWrt 内自由部署容器应用  
- 🚫 集成应用过滤功能，支持游戏、视频、聊天、下载等分类管理  
- 👥 提供在线用户管理，可查看设备 IP、实时速率等信息  
- 📦 ARMv8 固件内置晶晨宝盒，支持在线更新固件及内核
